...
style.configure("Spotify.TButton", background="#1DB954", foreground="white", font=("Arial", 24), borderwidth=0, relief="flat")
style.map("Spotify.TButton", background=[("active", "#1ed760")])
